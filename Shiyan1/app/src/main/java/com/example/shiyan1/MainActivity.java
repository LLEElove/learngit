...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    Button btn_0,btn_1,btn_2,btn_3,btn_4,btn_5,btn_6,
            ...
            btn_sub,btn_add,btn_equ,btn_p,btn_jie;
    EditText text;
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            ...
            case R.id.btn_jie:
                ...
                double sum=1;
                for(int i=1;i<=ans;i++) {//循环num
                    sum *= i;//每循环一次进行乘法运算
                }
                //sinn=Math.toRadians(sinn);
                //sinn=Math.sin(sinn);
                String ans1=String.format("%.9f",sum);//规避极小误差
                ans1 = ans1.replaceAll("0+?$", "");//去掉多余的0
                ans1 = ans1.replaceAll("[.]$", "");//如最后一位是.则去掉
                text.setText(ans1);
                break;
            case R.id.btn_sin:
